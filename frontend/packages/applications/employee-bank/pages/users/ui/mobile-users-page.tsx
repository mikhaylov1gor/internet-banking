...
export const MobileUsersPage: React.FC = () => {
  ...
  return (
    <div className="users-page-container mobile-users-page">
      <h1 className="users-page-title mobile-users-title">Список пользователей</h1>

      <div className="users-page-search-section mobile-search-section">
        <div className="users-page-search-box mobile-search-box">
          <Input
      ...
      <div className="users-page-filters-section mobile-filters-section">
        <div className="users-page-filters mobile-filters">
          <div className="users-page-filter-buttons mobile-filter-buttons">
            <Button
        ...
        <Button onClick={() => setShowCreateModal(true)} className="mobile-create-button">
        ...
        <>
          <div className="users-page-list mobile-users-list">
            {users.map((user) => (
              <div
                key={user.id}
                className="users-page-user-card mobile-user-card"
              ...
              >
                ...
                <Button
                  ...
                  className="mobile-user-action-button"
                >
      ...
      >
        <div className="users-page-create-form mobile-create-form">
          <Select
            label="Тип"
          ...
          <div className="users-page-modal-actions mobile-modal-actions">
