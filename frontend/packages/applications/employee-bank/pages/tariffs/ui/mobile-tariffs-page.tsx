...
export const MobileTariffsPage: React.FC = () => {
  const {
    name,
    setName,
    rate,
  ...
  return (
    <div className="tariffs-page-container mobile-tariffs-page">
      <div className="tariffs-page-header mobile-tariffs-header">
        <h1 className="tariffs-page-title mobile-tariffs-title">Тарифы кредитов</h1>
        <Button onClick={handleOpenModal} className="mobile-create-tariff-button">
          Создать новый тариф
        </Button>
      </div>
      ...
      <div className="content">
        <div className="listSection">
          ...
          {tariffs && tariffs.length > 0 && (
            <div className="list mobile-tariffs-list">
              {tariffs.map((tariff) => (
                <div key={tariff.id} className="tariffCard mobile-tariffCard">
      ...
      <Modal isOpen={showModal} onClose={handleCloseModal} title="Создать новый тариф">
        <form onSubmit={handleSubmit} className="tariffs-page-form mobile-tariffs-form">
          <Input
            label="Название"
            value={name}
            onChange={(e) => {
          ...
          <div className="modalActions mobile-modal-actions">
